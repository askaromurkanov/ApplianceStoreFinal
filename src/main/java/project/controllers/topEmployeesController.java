...
public class topEmployeesController {
    ...
    @FXML
    private TableColumn<Employee, Integer> quantity_col;
...
//        System.out.println(image.get);
    ...
    private void table(){
        ObservableList<Employee> oblist = Employee.topEmployees();
        ...
        quantity_col.setCellValueFactory(new PropertyValueFactory<Employee,Integer>("quantity"));
